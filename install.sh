...
#Install SSR
wget -N --no-check-certificate https://raw.githubusercontent.com/FeulerLoup/shadowsocks_install/master/shadowsocksR.sh
...
#Install Caddy
wget -N --no-check-certificate https://raw.githubusercontent.com/FeulerLoup/scripts/master/caddy_install.sh
chmod +x caddy_install.sh && bash caddy_install.sh install http.filemanager
rm -rf caddy_install.sh

#Install SWEB
cd /usr/local/
git clone https://github.com/FeulerLoup/SWEB
...
wget -N --no-check-certificate -O /usr/local/bin/sweb https://raw.githubusercontent.com/FeulerLoup/SWEB/master/sweb
