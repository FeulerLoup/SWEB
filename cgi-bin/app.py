...
<div id="download" class="container">
     ...
     <p class="sixteen columns"></p>
              ...
              <div class="col-md-4">
     <div class="one-third column last"><h3><i class="fa fa-android fa-3x"></i> &nbsp; Android</h3><ul><li>Shadowsocksr-Android:<ul><li><a href="https://github.com/shadowsocksrr/shadowsocksr-android/releases">点击下载</a> </li></ul></li></ul></div>
     </div>
              <div class="col-md-4">
